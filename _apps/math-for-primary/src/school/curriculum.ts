...
[2,'standard',N,'MONEY','Money',33,'Write dollars and cents using decimal notation|Compare amounts of money|Convert between dollars and cents|Count amounts in dollars and cents'],
...
[4,'standard',N,'WN','Whole numbers',37,'Represent and compare numbers to 100000|Round to the nearest 10 100 and 1000|Estimate and check calculations|Read and write number names to 100000|Continue number patterns to 100000'],
...
[4,'standard',G,'SOLID','Three-dimensional shapes',39,'Represent cubes cuboids cones cylinders prisms and pyramids|Draw cubes cuboids prisms and pyramids|Recognise nets of cubes cuboids prisms and pyramids'],
[4,'standard',S,'GRAPH','Tables and graphs',40,'Read and interpret tables|Read and interpret line graphs|Read and interpret pie charts|Complete tables from given data'],
...
[5,'foundation',N,'MD','Multiplication and division',45,'Multiply and divide up to two digits by one digit without a calculator|Multiply and divide by 10 100 and 1000 and their multiples without a calculator|Use the order of operations and brackets|Recall multiplication and division facts'],
...
[5,'foundation',G,'ANGLE','Angles',47,'Use angle notation and a protractor|Draw angles|Use straight-line around-a-point and vertically opposite angle facts|Find unknown angles'],
[5,'foundation',G,'SHAPE','Rectangles and squares',47,'Use rectangle and square properties excluding diagonals|Draw rectangles and squares'],
[5,'foundation',S,'GRAPH','Tables and graphs',48,'Read tables|Read bar graphs|Read line graphs|Complete tables from given data'],
...
[6,'foundation',G,'AREA','Area of triangles',49,'Identify a triangle base and perpendicular height|Find the area of a triangle|Find areas and perimeters of composite figures with rectangles squares and triangles'],
[6,'foundation',G,'VOL','Volume',49,'Find volumes of cubes and cuboids|Find liquid volume in rectangular tanks|Convert between litres millilitres and cm³'],
[6,'foundation',G,'SHAPE','Angles in geometric figures',49,'Use rectangle square and triangle properties|Use the angle sum of a triangle|Find angles in composite figures without adding lines'],
