...
export function SchoolNav(){
 ...
 return <header className="school-header"><div className="school-masthead"><a className="school-wordmark" href="#/" aria-label="Maths for SG Primary Schools — home"><span className="school-brand-symbol" aria-hidden="true">✦</span><span><strong>Maths for SG<br className="brand-break"/> Primary Schools</strong><small>A little curiosity. A world of maths.</small></span></a><span className="school-brand-note">LEARN · EXPLORE · UNDERSTAND</span></div><nav className="school-nav" aria-label="School navigation"><div><a href="#/teach">Learn</a><a href="#/curriculum">Curriculum</a><a href="#/about">About</a><a href={staff?'#/school':'#/school-start'}>{staff?'My school':'School setup'}</a></div><a className="account-link" href="#/account">{user?user.name:'School sign in'} <span aria-hidden="true">↗</span></a>
