...
const ten=()=>check('ten','A full ten frame holds one ten. How many ones make that ten?','10',{kind:'counters',count:10,frame:10},'Count every counter in the full frame.','Ten ones can be grouped as one ten. The amount stays the same.');
