...
export function coachedGuide(p:PlanEntry):VisualGuide|null{
 ...
 step('This strip stands for one whole sandwich. Cut it into four equal pieces.',strips([4],[0]),'A fraction describes part of a chosen whole. Equal pieces let us give every piece the same name.'),
