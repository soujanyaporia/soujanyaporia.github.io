...
export function LearnIndex(){
 ...
 return <main className={`teach learn-index grade-${level}`}><header className="learn-head"><p className="teach-eyebrow">Learn a new idea</p><h1>{level<=2?'Let’s find out how maths works.':'Understand it, then master it.'}</h1><p className="stage-text">Each lesson starts with what you already know, lets you explore with pictures and models, works through examples with you, and ends with a check that you really understand.</p></header>
  <RewardStrip/>
