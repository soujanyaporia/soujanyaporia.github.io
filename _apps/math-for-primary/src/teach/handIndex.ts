...
/**
 * Metadata for the hand-written exemplar lessons. Kept separate from the generated plan so the
 * lightweight index (main bundle) and the full lesson catalog (loaded on demand) cannot drift:
 * both are built from this file plus `build/plan.ts`, and the lesson tests compare them.
 */
...
export const HAND_INDEX:LessonMeta[]=[
